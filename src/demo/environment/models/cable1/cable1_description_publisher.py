...
class Cable1DescPub(Node):

    def __init__(self, args):

        super().__init__('cable1_description_publisher')
        ...
        rclpy.logging.set_logger_level(
            'cable1_description_publisher', rclpy.logging.LoggingSeverity.ERROR)
        ...
        self.publisher_ = self.create_publisher(
            String, '/cable1_description', latched_qos)
...
def main(args=None):
    ...
    cable1_description_publisher = Cable1DescPub(args_without_ros)

    rclpy.spin(cable1_description_publisher)

    cable1_description_publisher.destroy_node()
